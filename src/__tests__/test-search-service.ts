		...
		createOrUpdateIndex(
			...
			switch (call.request.getName()) {
				...
				case SearchServiceFixtures.CreateIndex.Blog:
					...
					expect(schema).toBe(
						'{"title":"blogPosts","additionalProperties":false,"type":"object","properties":{"text":{"type":"string"},"comments":{"type":"array","items":{"type":"string"}},"author":{"type":"string"},"createdAt":{"type":"string","format":"date-time","sort":true}}}'
					);
