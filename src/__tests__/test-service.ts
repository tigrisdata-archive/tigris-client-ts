...
import {
    ...
    CollectionMetadata, CollectionDescription, ResponseMetadata, GetInfoRequest, GetInfoResponse, TransactionCtx
    ...
    public impl: ITigrisServer = {
        ...
        beginTransaction(call: ServerUnaryCall<BeginTransactionRequest, BeginTransactionResponse>, callback: sendUnaryData<BeginTransactionResponse>): void {
            ...
            if (call.request.getDb() === 'test-tx') {
                ...
                reply.setTxCtx(new TransactionCtx().setId(TestTigrisService.txId).setOrigin(TestTigrisService.txOrigin))
